...
const Nuestras = () => {
  return (
    ...
    >
      ...
      <div className=" border-[0.5px] border-[#828F92] rounded-2xl bg-[url(../src/assets/image/Luxury_bg.webp)] bg-cover bg-center bg-no-repeat py-6 sm:py-[46px] relative z-10">
